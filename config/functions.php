            ...
            while($row = $result->fetch_assoc()) {
              ...
              echo '
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <a href="http://localhost/ekskul-day03-php-crud-jou/?menu=ekskul&page=update&id='. $row["id"] .'" class="btn btn-lg btn-outline-success w-100"><i class="fa-solid fa-pencil me-2"></i> Update</a>
                    </li>
